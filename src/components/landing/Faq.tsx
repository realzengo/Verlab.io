                ...
                return (
                  <div key={item.id} className="overflow-hidden rounded-2xl bg-zinc-100 transition-colors duration-300 dark:bg-white/[0.06]">
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-2 rounded-2xl px-2.5 py-3.5 text-left transition-colors duration-200 focus:outline-none sm:gap-4 sm:px-8 sm:py-6"
                    >
