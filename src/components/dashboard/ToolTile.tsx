...
export function ToolTile({ tool }: { tool: ToolTileData }) {
  return (
    <Link
      href={tool.href}
      className="flex flex-col items-center gap-2.5 rounded-card-sm border border-hairline bg-white p-4 text-center transition-colors hover:border-primary/40 hover:bg-accent"
    >
