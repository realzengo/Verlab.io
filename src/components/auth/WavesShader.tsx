...
// WavesShader — zero-dependency WebGL canvas ("Waves" preset) used for the
// Image Generator tool background.
...
export function WavesShader({ className }: { className?: string }) {
