...
export function SopGeneratingCard({ nicheName }: { nicheName?: string }) {
  ...
  return (
    <Card className="animate-bend-in mx-auto flex w-full max-w-sm flex-col items-center gap-5 p-8 text-center">
